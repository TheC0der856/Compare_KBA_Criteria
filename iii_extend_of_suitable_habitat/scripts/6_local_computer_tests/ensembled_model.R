...
# before starting the code make sure you are in the right working directory!
# > getwd()
# [1] "C:/Users/Gronefeld/Desktop/Compare_KBA_Criteria/iii_extend_of_suitable_habitat"
