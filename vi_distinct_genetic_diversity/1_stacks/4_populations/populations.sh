...
# calculation
populations -M cstacks/catalog/ID_and_Pop3.txt -P denovomap2 -t 24 -O populations  --fstats --vcf --genepop --structure --plink --phylip -p 4 -r 0.8 --min-maf 0.05 --write-single-snp
