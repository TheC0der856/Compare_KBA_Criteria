...
# rename files
list.files()
file.rename("02_radiator_genomic_converter_20250825@1243", "genetic_structure")
setwd("genetic_structure")
list.files()
file.rename("radiator_data_20250825@1243.tfam", "genetic_structure.tfam")
file.rename("radiator_data_20250825@1243.tped", "genetic_structure.tped")
